...
func (p *StmtSummaryProvider) statToMap(stat *StmtStats) map[string]interface{} {
	...
	m := map[string]interface{}{
		...
		"sum_cop_process_time": stat.SumCopProcessTime.Microseconds(), "sum_cop_process_time_us": stat.SumCopProcessTime.Microseconds(), "max_cop_process_time": stat.MaxCopProcessTime.Microseconds(), "max_cop_process_time_us": stat.MaxCopProcessTime.Microseconds(),
		"max_cop_process_address": stat.MaxCopProcessAddress,
		"sum_cop_wait_time":       stat.SumCopWaitTime.Microseconds(), "sum_cop_wait_time_us": stat.SumCopWaitTime.Microseconds(), "max_cop_wait_time": stat.MaxCopWaitTime.Microseconds(), "max_cop_wait_time_us": stat.MaxCopWaitTime.Microseconds(),
		...
		"sum_get_commit_ts_time":      stat.SumGetCommitTsTime.Microseconds(), "sum_get_commit_ts_time_us": stat.SumGetCommitTsTime.Microseconds(), "max_get_commit_ts_time": stat.MaxGetCommitTsTime.Microseconds(), "max_get_commit_ts_time_us": stat.MaxGetCommitTsTime.Microseconds(),
		...
		"sum_local_latch_time": stat.SumLocalLatchTime.Microseconds(), "sum_local_latch_time_us": stat.SumLocalLatchTime.Microseconds(), "max_local_latch_wait_time": stat.MaxLocalLatchTime.Microseconds(), "max_local_latch_time_us": stat.MaxLocalLatchTime.Microseconds(),
		...
		"sum_prewrite_region_num": stat.SumPrewriteRegionNum, "max_prewrite_regions": int64(stat.MaxPrewriteRegionNum), "max_prewrite_region_num": int64(stat.MaxPrewriteRegionNum),
		...
		"plan_cache_unqualified": stat.PlanCacheUnqualifiedCount, "plan_cache_unqualified_count": stat.PlanCacheUnqualifiedCount, "plan_cache_unqualified_last_reason": stat.PlanCacheUnqualifiedLastReason,
		...
		"exec_retry_count": int64(stat.ExecRetryCount), "exec_retry_time": stat.ExecRetryTime.Microseconds(), "exec_retry_time_us": stat.ExecRetryTime.Microseconds(),
		...
		"sum_ru_wait_duration": stat.SumRUWaitDuration.Microseconds(), "sum_ru_wait_duration_us": stat.SumRUWaitDuration.Microseconds(), "max_ru_wait_duration": stat.MaxRUWaitDuration.Microseconds(), "max_ru_wait_duration_us": stat.MaxRUWaitDuration.Microseconds(),
...
func getAllStatementColumns() []string {
	return []string{
		...
		"sum_local_latch_time_us", "max_local_latch_wait_time", "max_local_latch_time_us", "avg_local_latch_wait_time",
		...
		"sum_prewrite_region_num", "max_prewrite_regions", "max_prewrite_region_num", "avg_prewrite_regions",
		...
		"plan_cache_unqualified", "plan_cache_unqualified_count", "plan_cache_unqualified_last_reason",
		// Timestamps
