...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:42VHKI878d32tghnUyEywJVxNb8khBXGErOGLAfMHhQ=",
        version = "v2.0.8-0.20230714100000-19ef4377cfb1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:N1m2YFtQAZEkk5ilmsMqauELh29TJQrX2JbcNhdnm7k=",
        version = "v0.0.0-20230717031845-58eb48b840e7",
    )
    go_repository(
