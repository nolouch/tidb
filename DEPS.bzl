...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:GU84/jM5rzgO2B5IiR5mCvT3uFDiBxTBa97JWJOMmxM=",
        version = "v2.0.8-0.20230525083351-388baf327286",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:L3hsYgbvjT+mtLJRWs785htZqrUzgblnCbxC5roBIN8=",
        version = "v0.0.0-20230526040739-8b16b71aabd2",
    )
    go_repository(
